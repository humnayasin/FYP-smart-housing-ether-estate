...
//convert currency to token 
const tokens = (n) => {
    return ethers.utils.parseUnits(n.toString(), 'ether')
}
//here we pull all the tests for the escrow contract 
describe('Escrow', () => {
    ...
    beforeEach(async () => {
        ...
        escrow = await Escrow.deploy(
            ...
            await transaction.wait();
            //List property
            transation = await escrow.connect(seller).list(1,buyer.address, tokens(10), tokens(5));
            await transaction.wait();
